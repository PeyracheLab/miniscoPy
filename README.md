...
```
pip3 install --user numpy scipy matplotlib jupyter pandas cython scikit-learn scikit-image sklearn h5py opencv-python tqdm
```
...
pip3 install av
```
If it does not work, the best strategy is to start a conda environment :
```
